( function(){
    ...
    function alertMessage(){
        alert("Welcome to DavisOS! Although this website isn't totally complete just yet, feel free to explore this interactive website as if it was a desktop interface! I hope you enjoy :)")
    };
